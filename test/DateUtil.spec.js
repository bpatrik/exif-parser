...
describe('DateUtil', function () {
    ...
    it('should parse unix epoch without timezone', function () {
    ...
    it('should parse given date without timezone', function () {
    ...
    it('should parse invalid date without timezone should not return anything', function () {
        var dateStr = '1990:AA:14 14:30:14';
        var timestamp = DateUtil_1.DateUtil.parseDateWithSpecFormat(dateStr);
        assert.strictEqual(timestamp, undefined);
    });
    it('should parse given date with timezone', function () {
    ...
    it('should parse invalid date with timezone', function () {
        var dateStr = '2004-09-04T23:39:06A08:00';
        var timestamp = DateUtil_1.DateUtil.parseDateWithTimezoneFormat(dateStr);
        assert.strictEqual(timestamp, undefined);
    });
    it('should parseExifDate', function () {
        assert.strictEqual(DateUtil_1.DateUtil.parseExifDate('1970:01:01 00:00:00'), 0);
        assert.strictEqual(DateUtil_1.DateUtil.parseExifDate('1970-01-01T00:00:00-01:00'), 3600);
    });
});
//# sourceMappingURL=DateUtil.spec.js.map